## secure
### Title: Unconditionally Secure Access Control Encryption. (arXiv:2305.07593v1 [cs.CR])
* Paper URL: [http://arxiv.org/abs/2305.07593](http://arxiv.org/abs/2305.07593)
* Code URL: null
* Copy Paste: `<input type="checkbox">[[2305.07593] Unconditionally Secure Access Control Encryption](http://arxiv.org/abs/2305.07593) #secure`
* Summary: <p>Access control encryption (ACE) enforces, through a sanitizer as the
...
* Paper URL: [http://arxiv.org/abs/2305.07214](http://arxiv.org/abs/2305.07214)
* Code URL: null
* Copy Paste: `<input type="checkbox">[[2305.07214] MMG-Ego4D: Multi-Modal Generalization in Egocentric Action Recognition](http://arxiv.org/abs/2305.07214) #security`
* Summary: <p>In this paper, we study a novel problem in egocentric action recognition,
...
### Title: Configurable Spatial-Temporal Hierarchical Analysis for Flexible Video Anomaly Detection. (arXiv:2305.07328v1 [cs.CV])
* Paper URL: [http://arxiv.org/abs/2305.07328](http://arxiv.org/abs/2305.07328)
* Code URL: null
* Copy Paste: `<input type="checkbox">[[2305.07328] Configurable Spatial-Temporal Hierarchical Analysis for Flexible Video Anomaly Detection](http://arxiv.org/abs/2305.07328) #security`
* Summary: <p>Video anomaly detection (VAD) is a vital task with great practical
...
### Title: Gotcha! I Know What You are Doing on the FPGA Cloud: Fingerprinting Co-Located Cloud FPGA Accelerators via Measuring Communication Links. (arXiv:2305.07209v1 [cs.CR])
* Paper URL: [http://arxiv.org/abs/2305.07209](http://arxiv.org/abs/2305.07209)
* Code URL: null
* Copy Paste: `<input type="checkbox">[[2305.07209] Gotcha! I Know What You are Doing on the FPGA Cloud: Fingerprinting Co-Located Cloud FPGA Accelerators via Measuring Communication Links](http://arxiv.org/abs/2305.07209) #security`
* Summary: <p>In recent decades, due to the emerging requirements of computation
...
## privacy
### Title: Differentially Private Set-Based Estimation Using Zonotopes. (arXiv:2305.07407v1 [cs.CR])
* Paper URL: [http://arxiv.org/abs/2305.07407](http://arxiv.org/abs/2305.07407)
* Code URL: null
* Copy Paste: `<input type="checkbox">[[2305.07407] Differentially Private Set-Based Estimation Using Zonotopes](http://arxiv.org/abs/2305.07407) #privacy`
* Summary: <p>For large-scale cyber-physical systems, the collaboration of spatially
...
### Title: Comparison of machine learning models applied on anonymized data with different techniques. (arXiv:2305.07415v1 [cs.LG])
* Paper URL: [http://arxiv.org/abs/2305.07415](http://arxiv.org/abs/2305.07415)
* Code URL: null
* Copy Paste: `<input type="checkbox">[[2305.07415] Comparison of machine learning models applied on anonymized data with different techniques](http://arxiv.org/abs/2305.07415) #privacy`
* Summary: <p>Anonymization techniques based on obfuscating the quasi-identifiers by means
...
* Paper URL: [http://arxiv.org/abs/2305.07116](http://arxiv.org/abs/2305.07116)
* Code URL: [https://github.com/pepijndereus/privacy-enhancing-ml](https://github.com/pepijndereus/privacy-enhancing-ml)
* Copy Paste: `<input type="checkbox">[[2305.07116] Energy cost and machine learning accuracy impact of k-anonymisation and synthetic data techniques](http://arxiv.org/abs/2305.07116) #privacy`
* Summary: <p>To address increasing societal concerns regarding privacy and climate, the EU
...
* Paper URL: [http://arxiv.org/abs/2305.07512](http://arxiv.org/abs/2305.07512)
* Code URL: null
* Copy Paste: `<input type="checkbox">[[2305.07512] Learn to Unlearn: A Survey on Machine Unlearning](http://arxiv.org/abs/2305.07512) #privacy`
* Summary: <p>Machine Learning (ML) models contain private information, and implementing
...
## defense
## attack
### Title: ViT Unified: Joint Fingerprint Recognition and Presentation Attack Detection. (arXiv:2305.07602v1 [cs.CV])
* Paper URL: [http://arxiv.org/abs/2305.07602](http://arxiv.org/abs/2305.07602)
* Code URL: null
* Copy Paste: `<input type="checkbox">[[2305.07602] ViT Unified: Joint Fingerprint Recognition and Presentation Attack Detection](http://arxiv.org/abs/2305.07602) #attack`
* Summary: <p>A secure fingerprint recognition system must contain both a presentation
...
* Paper URL: [http://arxiv.org/abs/2305.07085](http://arxiv.org/abs/2305.07085)
* Code URL: null
* Copy Paste: `<input type="checkbox">[[2305.07085] Enhancing Contrastive Learning with Noise-Guided Attack: Towards Continual Relation Extraction in the Wild](http://arxiv.org/abs/2305.07085) #attack`
* Summary: <p>The principle of continual relation extraction~(CRE) involves adapting to
...
* Paper URL: [http://arxiv.org/abs/2305.07406](http://arxiv.org/abs/2305.07406)
* Code URL: null
* Copy Paste: `<input type="checkbox">[[2305.07406] Two-in-One: A Model Hijacking Attack Against Text Generation Models](http://arxiv.org/abs/2305.07406) #attack`
* Summary: <p>Machine learning has progressed significantly in various applications ranging
...
### Title: SigRec: Automatic Recovery of Function Signatures in Smart Contracts. (arXiv:2305.07067v1 [cs.CR])
* Paper URL: [http://arxiv.org/abs/2305.07067](http://arxiv.org/abs/2305.07067)
* Code URL: null
* Copy Paste: `<input type="checkbox">[[2305.07067] SigRec: Automatic Recovery of Function Signatures in Smart Contracts](http://arxiv.org/abs/2305.07067) #attack`
* Summary: <p>Millions of smart contracts have been deployed onto Ethereum for providing
...
### Title: A Lightweight Authentication Protocol against Modeling Attacks based on a Novel LFSR-APUF. (arXiv:2305.07254v1 [cs.CR])
* Paper URL: [http://arxiv.org/abs/2305.07254](http://arxiv.org/abs/2305.07254)
* Code URL: null
* Copy Paste: `<input type="checkbox">[[2305.07254] A Lightweight Authentication Protocol against Modeling Attacks based on a Novel LFSR-APUF](http://arxiv.org/abs/2305.07254) #attack`
* Summary: <p>Simple authentication protocols based on conventional physical unclonable
...
## robust
### Title: Surgical tool classification and localization: results and methods from the MICCAI 2022 SurgToolLoc challenge. (arXiv:2305.07152v1 [cs.CV])
* Paper URL: [http://arxiv.org/abs/2305.07152](http://arxiv.org/abs/2305.07152)
* Code URL: null
* Copy Paste: `<input type="checkbox">[[2305.07152] Surgical tool classification and localization: results and methods from the MICCAI 2022 SurgToolLoc challenge](http://arxiv.org/abs/2305.07152) #robust`
* Summary: <p>The ability to automatically detect and track surgical instruments in
...
### Title: Meta-Optimization for Higher Model Generalizability in Single-Image Depth Prediction. (arXiv:2305.07269v1 [cs.CV])
* Paper URL: [http://arxiv.org/abs/2305.07269](http://arxiv.org/abs/2305.07269)
* Code URL: null
* Copy Paste: `<input type="checkbox">[[2305.07269] Meta-Optimization for Higher Model Generalizability in Single-Image Depth Prediction](http://arxiv.org/abs/2305.07269) #robust`
* Summary: <p>Model generalizability to unseen datasets, concerned with in-the-wild
...
### Title: Efficient Search of Comprehensively Robust Neural Architectures via Multi-fidelity Evaluation. (arXiv:2305.07308v1 [cs.CV])
* Paper URL: [http://arxiv.org/abs/2305.07308](http://arxiv.org/abs/2305.07308)
* Code URL: null
* Copy Paste: `<input type="checkbox">[[2305.07308] Efficient Search of Comprehensively Robust Neural Architectures via Multi-fidelity Evaluation](http://arxiv.org/abs/2305.07308) #robust`
* Summary: <p>Neural architecture search (NAS) has emerged as one successful technique to
...
### Title: Gallery Sampling for Robust and Fast Face Identification. (arXiv:2305.07495v1 [cs.CV])
* Paper URL: [http://arxiv.org/abs/2305.07495](http://arxiv.org/abs/2305.07495)
* Code URL: null
* Copy Paste: `<input type="checkbox">[[2305.07495] Gallery Sampling for Robust and Fast Face Identification](http://arxiv.org/abs/2305.07495) #robust`
* Summary: <p>Deep learning methods have been achieved brilliant results in face
...
### Title: Spider GAN: Leveraging Friendly Neighbors to Accelerate GAN Training. (arXiv:2305.07613v1 [cs.CV])
* Paper URL: [http://arxiv.org/abs/2305.07613](http://arxiv.org/abs/2305.07613)
* Code URL: null
* Copy Paste: `<input type="checkbox">[[2305.07613] Spider GAN: Leveraging Friendly Neighbors to Accelerate GAN Training](http://arxiv.org/abs/2305.07613) #robust`
* Summary: <p>Training Generative adversarial networks (GANs) stably is a challenging task.
...
### Title: Model-based Programming: Redefining the Atomic Unit of Programming for the Deep Learning Era. (arXiv:2305.07341v1 [cs.LG])
* Paper URL: [http://arxiv.org/abs/2305.07341](http://arxiv.org/abs/2305.07341)
* Code URL: null
* Copy Paste: `<input type="checkbox">[[2305.07341] Model-based Programming: Redefining the Atomic Unit of Programming for the Deep Learning Era](http://arxiv.org/abs/2305.07341) #robust`
* Summary: <p>This paper introduces and explores a new programming paradigm, Model-based
...
### Title: Investigating the Sensitivity of Automatic Speech Recognition Systems to Phonetic Variation in L2 Englishes. (arXiv:2305.07389v1 [cs.CL])
* Paper URL: [http://arxiv.org/abs/2305.07389](http://arxiv.org/abs/2305.07389)
* Code URL: null
* Copy Paste: `<input type="checkbox">[[2305.07389] Investigating the Sensitivity of Automatic Speech Recognition Systems to Phonetic Variation in L2 Englishes](http://arxiv.org/abs/2305.07389) #robust`
* Summary: <p>Automatic Speech Recognition (ASR) systems exhibit the best performance on
...
### Title: Improving Cascaded Unsupervised Speech Translation with Denoising Back-translation. (arXiv:2305.07455v1 [cs.CL])
* Paper URL: [http://arxiv.org/abs/2305.07455](http://arxiv.org/abs/2305.07455)
* Code URL: null
* Copy Paste: `<input type="checkbox">[[2305.07455] Improving Cascaded Unsupervised Speech Translation with Denoising Back-translation](http://arxiv.org/abs/2305.07455) #robust`
* Summary: <p>Most of the speech translation models heavily rely on parallel data, which is
...
* Paper URL: [http://arxiv.org/abs/2305.07457](http://arxiv.org/abs/2305.07457)
* Code URL: [https://github.com/tuanh23/perturbation-basedqe](https://github.com/tuanh23/perturbation-basedqe)
* Copy Paste: `<input type="checkbox">[[2305.07457] Perturbation-based QE: An Explainable, Unsupervised Word-level Quality Estimation Method for Blackbox Machine Translation](http://arxiv.org/abs/2305.07457) #robust`
* Summary: <p>Quality Estimation (QE) is the task of predicting the quality of Machine
...
* Paper URL: [http://arxiv.org/abs/2305.07216](http://arxiv.org/abs/2305.07216)
* Code URL: [https://github.com/ilucasgoncalves/vavl](https://github.com/ilucasgoncalves/vavl)
* Copy Paste: `<input type="checkbox">[[2305.07216] Versatile Audio-Visual Learning for Handling Single and Multi Modalities in Emotion Regression and Classification Tasks](http://arxiv.org/abs/2305.07216) #robust`
* Summary: <p>Most current audio-visual emotion recognition models lack the flexibility
...
* Paper URL: [http://arxiv.org/abs/2305.07484](http://arxiv.org/abs/2305.07484)
* Code URL: null
* Copy Paste: `<input type="checkbox">[[2305.07484] Online Learning Under A Separable Stochastic Approximation Framework](http://arxiv.org/abs/2305.07484) #robust`
* Summary: <p>We propose an online learning algorithm for a class of machine learning
...
* Paper URL: [http://arxiv.org/abs/2305.07583](http://arxiv.org/abs/2305.07583)
* Code URL: [https://github.com/fabian-sp/MoMo](https://github.com/fabian-sp/MoMo)
* Copy Paste: `<input type="checkbox">[[2305.07583] MoMo: Momentum Models for Adaptive Learning Rates](http://arxiv.org/abs/2305.07583) #robust`
* Summary: <p>We present new adaptive learning rates that can be used with any momentum
...
## steal
## extraction
### Title: Visual Information Extraction in the Wild: Practical Dataset and End-to-end Solution. (arXiv:2305.07498v1 [cs.CV])
* Paper URL: [http://arxiv.org/abs/2305.07498](http://arxiv.org/abs/2305.07498)
* Code URL: [https://github.com/jfkuang/cfam](https://github.com/jfkuang/cfam)
* Copy Paste: `<input type="checkbox">[[2305.07498] Visual Information Extraction in the Wild: Practical Dataset and End-to-end Solution](http://arxiv.org/abs/2305.07498) #extraction`
* Summary: <p>Visual information extraction (VIE), which aims to simultaneously perform OCR
...
### Title: Text2Cohort: Democratizing the NCI Imaging Data Commons with Natural Language Cohort Discovery. (arXiv:2305.07637v1 [cs.LG])
* Paper URL: [http://arxiv.org/abs/2305.07637](http://arxiv.org/abs/2305.07637)
* Code URL: null
* Copy Paste: `<input type="checkbox">[[2305.07637] Text2Cohort: Democratizing the NCI Imaging Data Commons with Natural Language Cohort Discovery](http://arxiv.org/abs/2305.07637) #extraction`
* Summary: <p>The Imaging Data Commons (IDC) is a cloud-based database that provides
...
* Paper URL: [http://arxiv.org/abs/2305.07135](http://arxiv.org/abs/2305.07135)
* Code URL: null
* Copy Paste: `<input type="checkbox">[[2305.07135] Divide-and-Conquer the NAS puzzle in Resource Constrained Federated Learning Systems](http://arxiv.org/abs/2305.07135) #federate`
* Summary: <p>Federated Learning (FL) is a privacy-preserving distributed machine learning
...
* Paper URL: [http://arxiv.org/abs/2305.07041](http://arxiv.org/abs/2305.07041)
* Code URL: null
* Copy Paste: `<input type="checkbox">[[2305.07041] Fairness in Machine Learning meets with Equity in Healthcare](http://arxiv.org/abs/2305.07041) #fair`
* Summary: <p>With the growing utilization of machine learning in healthcare, there is
...
* Paper URL: [http://arxiv.org/abs/2305.07224](http://arxiv.org/abs/2305.07224)
* Code URL: [https://github.com/stilllu/asiv](https://github.com/stilllu/asiv)
* Copy Paste: `<input type="checkbox">[[2305.07224] Asymmetric feature interaction for interpreting model predictions](http://arxiv.org/abs/2305.07224) #interpretability`
* Summary: <p>In natural language processing (NLP), deep neural networks (DNNs) could model
...
## explainability
### Title: eXplainable Artificial Intelligence on Medical Images: A Survey. (arXiv:2305.07511v1 [cs.LG])
* Paper URL: [http://arxiv.org/abs/2305.07511](http://arxiv.org/abs/2305.07511)
* Code URL: null
* Copy Paste: `<input type="checkbox">[[2305.07511] eXplainable Artificial Intelligence on Medical Images: A Survey](http://arxiv.org/abs/2305.07511) #explainability`
* Summary: <p>Over the last few years, the number of works about deep learning applied to
...
* Paper URL: [http://arxiv.org/abs/2305.07031](http://arxiv.org/abs/2305.07031)
* Code URL: null
* Copy Paste: `<input type="checkbox">[[2305.07031] Hawkes Process based on Controlled Differential Equations](http://arxiv.org/abs/2305.07031) #diffusion`
* Summary: <p>Hawkes processes are a popular framework to model the occurrence of
...
* Paper URL: [http://arxiv.org/abs/2305.07102](http://arxiv.org/abs/2305.07102)
* Code URL: [https://github.com/demidovd98/sm-vit](https://github.com/demidovd98/sm-vit)
* Copy Paste: `<input type="checkbox">[[2305.07102] Salient Mask-Guided Vision Transformer for Fine-Grained Classification](http://arxiv.org/abs/2305.07102) #transformer`
* Summary: <p>Fine-grained visual classification (FGVC) is a challenging computer vision
...
* Paper URL: [http://arxiv.org/abs/2305.07167](http://arxiv.org/abs/2305.07167)
* Code URL: null
* Copy Paste: `<input type="checkbox">[[2305.07167] OneCAD: One Classifier for All image Datasets using multimodal learning](http://arxiv.org/abs/2305.07167) #transformer`
* Summary: <p>Vision-Transformers (ViTs) and Convolutional neural networks (CNNs) are
...
### Title: T-former: An Efficient Transformer for Image Inpainting. (arXiv:2305.07239v1 [cs.CV])
* Paper URL: [http://arxiv.org/abs/2305.07239](http://arxiv.org/abs/2305.07239)
* Code URL: [https://github.com/dengyecode/t-former_image_inpainting](https://github.com/dengyecode/t-former_image_inpainting)
* Copy Paste: `<input type="checkbox">[[2305.07239] T-former: An Efficient Transformer for Image Inpainting](http://arxiv.org/abs/2305.07239) #transformer`
* Summary: <p>Benefiting from powerful convolutional neural networks (CNNs), learning-based
...
### Title: SSD-MonoDTR: Supervised Scale-constrained Deformable Transformer for Monocular 3D Object Detection. (arXiv:2305.07270v1 [cs.CV])
* Paper URL: [http://arxiv.org/abs/2305.07270](http://arxiv.org/abs/2305.07270)
* Code URL: [https://github.com/mikasa3lili/ssd-monodetr](https://github.com/mikasa3lili/ssd-monodetr)
* Copy Paste: `<input type="checkbox">[[2305.07270] SSD-MonoDTR: Supervised Scale-constrained Deformable Transformer for Monocular 3D Object Detection](http://arxiv.org/abs/2305.07270) #transformer`
* Summary: <p>Transformer-based methods have demonstrated superior performance for
...
### Title: RHINO: Rotated DETR with Dynamic Denoising via Hungarian Matching for Oriented Object Detection. (arXiv:2305.07598v1 [cs.CV])
* Paper URL: [http://arxiv.org/abs/2305.07598](http://arxiv.org/abs/2305.07598)
* Code URL: null
* Copy Paste: `<input type="checkbox">[[2305.07598] RHINO: Rotated DETR with Dynamic Denoising via Hungarian Matching for Oriented Object Detection](http://arxiv.org/abs/2305.07598) #transformer`
* Summary: <p>With the publication of DINO, a variant of the Detection Transformer (DETR),
...
### Title: Multi-Relational Hyperbolic Word Embeddings from Natural Language Definitions. (arXiv:2305.07303v1 [cs.CL])
* Paper URL: [http://arxiv.org/abs/2305.07303](http://arxiv.org/abs/2305.07303)
* Code URL: null
* Copy Paste: `<input type="checkbox">[[2305.07303] Multi-Relational Hyperbolic Word Embeddings from Natural Language Definitions](http://arxiv.org/abs/2305.07303) #transformer`
* Summary: <p>Neural-based word embeddings using solely distributional information have
...
* Paper URL: [http://arxiv.org/abs/2305.07475](http://arxiv.org/abs/2305.07475)
* Code URL: null
* Copy Paste: `<input type="checkbox">[[2305.07475] Comprehensive Solution Program Centric Pretraining for Table-and-Text Hybrid Numerical Reasoning](http://arxiv.org/abs/2305.07475) #transformer`
* Summary: <p>Numerical reasoning over table-and-text hybrid passages, such as financial
...
* Paper URL: [http://arxiv.org/abs/2305.07185](http://arxiv.org/abs/2305.07185)
* Code URL: null
* Copy Paste: `<input type="checkbox">[[2305.07185] MEGABYTE: Predicting Million-byte Sequences with Multiscale Transformers](http://arxiv.org/abs/2305.07185) #transformer`
* Summary: <p>Autoregressive transformers are spectacular models for short sequences but
...
### Title: AGFormer: Efficient Graph Representation with Anchor-Graph Transformer. (arXiv:2305.07521v1 [cs.LG])
* Paper URL: [http://arxiv.org/abs/2305.07521](http://arxiv.org/abs/2305.07521)
* Code URL: null
* Copy Paste: `<input type="checkbox">[[2305.07521] AGFormer: Efficient Graph Representation with Anchor-Graph Transformer](http://arxiv.org/abs/2305.07521) #transformer`
* Summary: <p>To alleviate the local receptive issue of GCN, Transformers have been
...
## generative
### Title: WEDGE: A multi-weather autonomous driving dataset built from generative vision-language models. (arXiv:2305.07528v1 [cs.CV])
* Paper URL: [http://arxiv.org/abs/2305.07528](http://arxiv.org/abs/2305.07528)
* Code URL: [https://github.com/Infernolia/WEDGE](https://github.com/Infernolia/WEDGE)
* Copy Paste: `<input type="checkbox">[[2305.07528] WEDGE: A multi-weather autonomous driving dataset built from generative vision-language models](http://arxiv.org/abs/2305.07528) #generative`
* Summary: <p>The open road poses many challenges to autonomous perception, including poor
...
* Paper URL: [http://arxiv.org/abs/2305.07289](http://arxiv.org/abs/2305.07289)
* Code URL: null
* Copy Paste: `<input type="checkbox">[[2305.07289] RepCL: Exploring Effective Representation for Continual Text Classification](http://arxiv.org/abs/2305.07289) #generative`
...
* Paper URL: [http://arxiv.org/abs/2305.07170](http://arxiv.org/abs/2305.07170)
* Code URL: null
* Copy Paste: `<input type="checkbox">[[2305.07170] Towards Understanding and Improving GFlowNet Training](http://arxiv.org/abs/2305.07170) #generative`
* Summary: <p>Generative flow networks (GFlowNets) are a family of algorithms that learn a
...
### Title: Provably Convergent Schr\"odinger Bridge with Applications to Probabilistic Time Series Imputation. (arXiv:2305.07247v1 [cs.LG])
* Paper URL: [http://arxiv.org/abs/2305.07247](http://arxiv.org/abs/2305.07247)
* Code URL: null
* Copy Paste: `<input type="checkbox">[[2305.07247] Provably Convergent Schr\"odinger Bridge with Applications to Probabilistic Time Series Imputation](http://arxiv.org/abs/2305.07247) #generative`
* Summary: <p>The Schr\"odinger bridge problem (SBP) is gaining increasing attention in
...
### Title: ArtGPT-4: Artistic Vision-Language Understanding with Adapter-enhanced MiniGPT-4. (arXiv:2305.07490v1 [cs.CL])
* Paper URL: [http://arxiv.org/abs/2305.07490](http://arxiv.org/abs/2305.07490)
* Code URL: null
* Copy Paste: `<input type="checkbox">[[2305.07490] ArtGPT-4: Artistic Vision-Language Understanding with Adapter-enhanced MiniGPT-4](http://arxiv.org/abs/2305.07490) #large language model`
* Summary: <p>In recent years, large language models (LLMs) have made significant progress
...
* Paper URL: [http://arxiv.org/abs/2305.07095](http://arxiv.org/abs/2305.07095)
* Code URL: [https://github.com/ink-usc/rationalehumanutility](https://github.com/ink-usc/rationalehumanutility)
* Copy Paste: `<input type="checkbox">[[2305.07095] Are Machine Rationales (Not) Useful to Humans? Measuring and Improving Human Utility of Free-Text Rationales](http://arxiv.org/abs/2305.07095) #large language model`
* Summary: <p>Among the remarkable emergent capabilities of large language models (LMs) is
...
* Paper URL: [http://arxiv.org/abs/2305.07157](http://arxiv.org/abs/2305.07157)
* Code URL: null
* Copy Paste: `<input type="checkbox">[[2305.07157] Exploring Zero and Few-shot Techniques for Intent Classification](http://arxiv.org/abs/2305.07157) #large language model`
* Summary: <p>Conversational NLU providers often need to scale to thousands of
...
* Paper URL: [http://arxiv.org/abs/2305.07230](http://arxiv.org/abs/2305.07230)
* Code URL: null
* Copy Paste: `<input type="checkbox">[[2305.07230] When Giant Language Brains Just Aren't Enough! Domain Pizzazz with Knowledge Sparkle Dust](http://arxiv.org/abs/2305.07230) #large language model`
* Summary: <p>Large language models (LLMs) have significantly advanced the field of natural
...
### Title: Harvesting Event Schemas from Large Language Models. (arXiv:2305.07280v1 [cs.CL])
* Paper URL: [http://arxiv.org/abs/2305.07280](http://arxiv.org/abs/2305.07280)
* Code URL: [https://github.com/tangjialong/event-schema-harvester](https://github.com/tangjialong/event-schema-harvester)
* Copy Paste: `<input type="checkbox">[[2305.07280] Harvesting Event Schemas from Large Language Models](http://arxiv.org/abs/2305.07280) #large language model`
* Summary: <p>Event schema provides a conceptual, structural and formal language to
...
* Paper URL: [http://arxiv.org/abs/2305.07340](http://arxiv.org/abs/2305.07340)
* Code URL: null
* Copy Paste: `<input type="checkbox">[[2305.07340] MedGPTEval: A Dataset and Benchmark to Evaluate Responses of Large Language Models in Medicine](http://arxiv.org/abs/2305.07340) #large language model`
* Summary: <p>METHODS: First, a set of evaluation criteria is designed based on a
...
* Paper URL: [http://arxiv.org/abs/2305.07378](http://arxiv.org/abs/2305.07378)
* Code URL: null
* Copy Paste: `<input type="checkbox">[[2305.07378] Surfacing Biases in Large Language Models using Contrastive Input Decoding](http://arxiv.org/abs/2305.07378) #large language model`
* Summary: <p>Ensuring that large language models (LMs) are fair, robust and useful
...
### Title: Knowledge Refinement via Interaction Between Search Engines and Large Language Models. (arXiv:2305.07402v1 [cs.CL])
* Paper URL: [http://arxiv.org/abs/2305.07402](http://arxiv.org/abs/2305.07402)
* Code URL: null
* Copy Paste: `<input type="checkbox">[[2305.07402] Knowledge Refinement via Interaction Between Search Engines and Large Language Models](http://arxiv.org/abs/2305.07402) #large language model`
* Summary: <p>Information retrieval (IR) plays a crucial role in locating relevant
...
* Paper URL: [http://arxiv.org/abs/2305.07504](http://arxiv.org/abs/2305.07504)
* Code URL: null
* Copy Paste: `<input type="checkbox">[[2305.07504] Calibration-Aware Bayesian Learning](http://arxiv.org/abs/2305.07504) #large language model`
* Summary: <p>Deep learning models, including modern systems like large language models,
...
## segmentation
### Title: Quaternion-valued Correlation Learning for Few-Shot Semantic Segmentation. (arXiv:2305.07283v1 [cs.CV])
* Paper URL: [http://arxiv.org/abs/2305.07283](http://arxiv.org/abs/2305.07283)
* Code URL: [https://github.com/zwzheng98/qclnet](https://github.com/zwzheng98/qclnet)
* Copy Paste: `<input type="checkbox">[[2305.07283] Quaternion-valued Correlation Learning for Few-Shot Semantic Segmentation](http://arxiv.org/abs/2305.07283) #segmentation`
* Summary: <p>Few-shot segmentation (FSS) aims to segment unseen classes given only a few
...
* Paper URL: [http://arxiv.org/abs/2305.07304](http://arxiv.org/abs/2305.07304)
* Code URL: [https://github.com/songrise/clip-count](https://github.com/songrise/clip-count)
* Copy Paste: `<input type="checkbox">[[2305.07304] CLIP-Count: Towards Text-Guided Zero-Shot Object Counting](http://arxiv.org/abs/2305.07304) #segmentation`
* Summary: <p>Recent advances in visual-language models have shown remarkable zero-shot
...
### Title: MotionBEV: Attention-Aware Online LiDAR Moving Object Segmentation with Bird's Eye View based Appearance and Motion Features. (arXiv:2305.07336v1 [cs.CV])
* Paper URL: [http://arxiv.org/abs/2305.07336](http://arxiv.org/abs/2305.07336)
* Code URL: [https://github.com/xiekkki/motionbev](https://github.com/xiekkki/motionbev)
* Copy Paste: `<input type="checkbox">[[2305.07336] MotionBEV: Attention-Aware Online LiDAR Moving Object Segmentation with Bird's Eye View based Appearance and Motion Features](http://arxiv.org/abs/2305.07336) #segmentation`
* Summary: <p>Identifying moving objects is an essential capability for autonomous systems,
...
### Title: Knowledge distillation with Segment Anything (SAM) model for Planetary Geological Mapping. (arXiv:2305.07586v1 [cs.CV])
* Paper URL: [http://arxiv.org/abs/2305.07586](http://arxiv.org/abs/2305.07586)
* Code URL: null
* Copy Paste: `<input type="checkbox">[[2305.07586] Knowledge distillation with Segment Anything (SAM) model for Planetary Geological Mapping](http://arxiv.org/abs/2305.07586) #segmentation`
* Summary: <p>Planetary science research involves analysing vast amounts of remote sensing
...
* Paper URL: [http://arxiv.org/abs/2305.07625](http://arxiv.org/abs/2305.07625)
* Code URL: [https://github.com/edi-meta-learning/meta-omnium](https://github.com/edi-meta-learning/meta-omnium)
* Copy Paste: `<input type="checkbox">[[2305.07625] Meta Omnium: A Benchmark for General-Purpose Learning-to-Learn](http://arxiv.org/abs/2305.07625) #segmentation`
* Summary: <p>Meta-learning and other approaches to few-shot learning are widely studied
...
### Title: The ASNR-MICCAI Brain Tumor Segmentation (BraTS) Challenge 2023: Intracranial Meningioma. (arXiv:2305.07642v1 [cs.CV])
* Paper URL: [http://arxiv.org/abs/2305.07642](http://arxiv.org/abs/2305.07642)
* Code URL: null
* Copy Paste: `<input type="checkbox">[[2305.07642] The ASNR-MICCAI Brain Tumor Segmentation (BraTS) Challenge 2023: Intracranial Meningioma](http://arxiv.org/abs/2305.07642) #segmentation`
* Summary: <p>Meningiomas are the most common primary intracranial tumor in adults and can
...
### Title: A Critical View Of Vision-Based Long-Term Dynamics Prediction Under Environment Misalignment. (arXiv:2305.07648v1 [cs.CV])
* Paper URL: [http://arxiv.org/abs/2305.07648](http://arxiv.org/abs/2305.07648)
* Code URL: null
* Copy Paste: `<input type="checkbox">[[2305.07648] A Critical View Of Vision-Based Long-Term Dynamics Prediction Under Environment Misalignment](http://arxiv.org/abs/2305.07648) #segmentation`
* Summary: <p>Dynamics prediction, which is the problem of predicting future states of
